...
{
    public const string UpdateZipName = @"SlippiTV.0.2.2-beta.zip";
    public const string UpdateDownloadLink = @$"https://github.com/asundheim/SlippiTV/releases/download/0.2.2-beta/{UpdateZipName}";
