...
{
    public const string UpdateZipName = @"SlippiTV.0.3.0-beta.zip";
    public const string UpdateDownloadLink = @$"https://github.com/asundheim/SlippiTV/releases/download/0.3.0-beta/{UpdateZipName}";
