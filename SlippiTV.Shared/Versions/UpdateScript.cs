...
{
    public const string UpdateZipName = @"SlippiTV-0.0.9-beta.zip";
    public const string UpdateDownloadLink = @$"https://github.com/asundheim/SlippiTV/releases/download/0.0.9-beta/{UpdateZipName}";
